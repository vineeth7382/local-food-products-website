        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have fresh fruits and vegetables. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/potato.jpg" alt="Cannon">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Potato</h3>
                                    <p>Price: 1kh:40 rupees</p>
                                    <p> Available : Yes</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ladiesfinger.jpg" alt="Sony DSLR">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>LadiesFinger</h3>
                                    <p>Price: 1kg-60 rupees</p>
									<p>Available: Yes<p>
									<p> Contact: 9876543210 <p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/tomato.jpg" alt="Sony DSLR">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tomato</h3>
                                    <p>Price: 1kg: 30 rupees</p>
									<p> Available: yes </p>
									<p> Contact: 9876543210 </p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/brinjal.jpg" alt="Olympus">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Brinjal</h3>
                                    <p>Price: 1kg :60 rupees </p>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/custardapple.jpeg" alt="custardapple">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Custard Apple</h3>
                                    <p>Price: 1 Dozen: 350 rupees</p>
									<p> Available: Yes </p>
									<p> Contact: 9876543210 </p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sapota.jpeg" alt="Titan 201">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sapota</h3>
                                    <p>Price: 1kg: 100 rupees</p>
									<p> Available : Yes </p>
									<p> Contact: 9876543210 </p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/targola.JPEG" alt="htm milan">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Targola</h3>
                                    <p>Price: 1 Packet 25 rupees</p>
									<p> Available : Yes </p>
									<p> Contact :9876543210</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/caranz.jpeg" alt="Favre Leuba">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Jamun</h3>
                                    <p>Price: 1kg : 100 rupees </p>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/panner.jpeg" alt="Raymond shirt">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Panner</h3>
                                    <p>Price: 1kg: 400 rupees</p>
									<p> Avaialable : Yes </p>
									<p> Contact : 9876543210 </p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ghee.jpeg" alt="Charles shirt">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Ghee</h3>
                                    <p>Price: 1kg :1000.00</p>
									<p> Available : Yes </p>
									<p> Contact: 9876543210 </p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/milk.jpeg" alt="HXR">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Milk</h3>
                                    <p>Price: 1 litre:90 rupees</p>
									<p> Available : Yes </p>
									<p> Contact : 9876543210 </p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/junnu.jpeg" alt="PINK">                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Junnu</h3>
                                    <p>Price: 1kg: 1000 rupees</p>
									<p> Available : Yes</p>
									<p> Contact :9876543210 </p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
